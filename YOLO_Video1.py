...
def process_image(image_path):
    model = YOLO("smoke.pt")
    classNames = ['cigarette', 'face-cigarette-smoking', 'smoke']
...
# Example usage
video_detection1('path_to_your_video_or_image_file')
